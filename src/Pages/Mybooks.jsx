...
const [showModal, setShowModal] = useState(false);
  ...
  return (
    ...
    <div className="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {myBooks.map(book => (
        <div key={book._id} className="card bg-base-100 shadow-sm border">
          <img src={book.cover_photo} alt={book.book_title} className="w-full h-64 object-cover rounded-lg " />
